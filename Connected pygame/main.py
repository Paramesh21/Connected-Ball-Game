...
connected = Message(WIDTH//2, 120, 55, "ConnecteD BalL", title_font, WHITE, win)
score_msg = Message(WIDTH//2, 100, 60, "0", score_font, (150, 150, 150), win)
game_msg = Message(80, 150, 40, "GAME", game_over_font, WHITE, win)
over_msg = Message(210, 150, 40, "OVER!", game_over_font, BLACK, win)
